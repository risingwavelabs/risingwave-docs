...
See [Best Practices - Resource Allocation](link-to-resource-allocation) for guidance on adjusting memory.  If you are experiencing high latency or slow stream processing, see [Troubleshooting - High Query Latency](link-to-high-latency) and [Troubleshooting - Slow Stream Processing](link-to-slow-stream-processing).
...
<Frame>
  <img src="/images/cash_miss_1.png"/>
</Frame>
...
<Frame>
  <img src="/images/cash_miss_2.png"/>
</Frame>
...
<Frame>
  <img src="/images/cash_miss_3.png"/>
</Frame>
...
4. If you are experiencing high latency or slow stream processing due to cache misses, see [Troubleshooting - High Query Latency](link-to-high-latency) and [Troubleshooting - Slow Stream Processing](link-to-slow-stream-processing). You may also need to address specific resource bottlenecks as described in [Troubleshooting - Specific Bottlenecks](link-to-specific-bottlenecks).
...
<Frame>
  <img src="/images/barrier_latency.png"/>
</Frame>
<br/>
<Frame>
  <img src="/images/barrier_number.png"/>
</Frame>
...
<Frame>
  <img src="/images/source_throughput.png"/>
</Frame>
