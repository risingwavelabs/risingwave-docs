...
2. [User dashboard (`risingwave-user-dashboard.dashboard.py`)](https://github.com/risingwavelabs/risingwave/blob/main/grafana/risingwave-user-dashboard.dashboard.py) — summarizes high-level metrics. Also available.
