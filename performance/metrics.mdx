...
1. When the CPU usage of the Streaming Node is close to the total number of CPUs this Node has (i.e., 800% in this case), we can likely improve the performance, e.g., throughput, by adding more CPUs to the Strearming Node.
