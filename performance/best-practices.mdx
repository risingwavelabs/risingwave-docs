...
- [Serving/Batch SQL Optimization](performance/serving-optimizations#sql-optimizations)
- [Streaming SQL Optimization](performance/streaming-optimizations#sql-optimizations)
