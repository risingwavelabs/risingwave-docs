...
- [Serving/Batch SQL Optimization](performance/serving-optimization#sql-optimizations)
- [Streaming SQL Optimization](performance/streaming-optimization#sql-optimizations)
