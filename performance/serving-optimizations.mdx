---
title: "Batch SQL optimization"
sidebarTitle: "Batch SQL"
description: "Optimize ad hoc batch queries in RisingWave with predicate pushdown, indexes, materialized view selection, and memory tuning."
---

This page outlines SQL optimization techniques for ad hoc batch queries, also called serving queries in RisingWave.
