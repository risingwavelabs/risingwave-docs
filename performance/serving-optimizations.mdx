...
<Tip>
Currently, MV selection requires an exact structural match between the query and the MV definition. Create an MV that precisely mirrors your most frequent query pattern for best results. We are actively working on broadening the matching to cover more cases in future releases.
</Tip>
