...
<Note>For enhanced security, you can store credentials like S3 access keys as secrets instead of providing them directly. If you wish to use this feature, see [Manage secrets](/operate/manage-secrets).</Note>
...
- For normal tables, RisingWave will keep a copy of the table in the row format, in order to support streaming
