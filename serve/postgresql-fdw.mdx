---
title: "Query RisingWave from PostgreSQL via FDW"
sidebarTitle: PostgreSQL FDW
description: "Use PostgreSQL's foreign data wrapper (postgres_fdw) to query RisingWave tables and materialized views as if they were local PostgreSQL tables."
---
