...
For details, see [Integrate with PostgreSQL via foreign data wrapper (FDW)](/serve/risingwave-as-postgres-fdw).
...
For details, see [Subscribe to real-time updates](/serve/subscription).
