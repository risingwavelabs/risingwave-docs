...
Use the syntax below to create, drop or alter subscription. For detailed syntax and examples, see [CREATE SUBSCRIPTION](/sql/commands/sql-create-subscription), [DROP SUBSCRIPTION](/sql/commands/sql-drop-subscription), and [ALTER SUBSCRIPTION](/sql/commands/sql-alter-subscription).
