...
For complete syntax reference and more examples, see [CREATE SUBSCRIPTION](/sql/commands/sql-create-subscription).
...
For complete syntax reference, see [DROP SUBSCRIPTION](/sql/commands/sql-drop-subscription).
