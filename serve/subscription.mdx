...
For complete syntax details and examples, see [CREATE SUBSCRIPTION](/sql/commands/sql-create-subscription).
...
For complete syntax details and examples, see [DROP SUBSCRIPTION](/sql/commands/sql-drop-subscription).
...
For complete syntax details and examples, see [ALTER SUBSCRIPTION](/sql/commands/sql-alter-subscription).
