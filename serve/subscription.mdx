...
<Note>
For the complete command reference, see [CREATE SUBSCRIPTION](/sql/commands/sql-create-subscription).
</Note>
...
<Note>
For the complete command reference, see [DROP SUBSCRIPTION](/sql/commands/sql-drop-subscription).
</Note>
...
<Note>
For the complete command reference, see [ALTER SUBSCRIPTION](/sql/commands/sql-alter-subscription).
</Note>
