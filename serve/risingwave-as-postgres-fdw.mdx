---
title: "Integrate with PostgreSQL via foreign data wrapper (FDW)"
sidebarTitle: PostgreSQL FDW
description: "Use PostgreSQL's foreign data wrapper to query RisingWave tables and materialized views as if they were local PostgreSQL tables."
---
