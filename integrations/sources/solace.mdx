...
To set up [Solace PubSub+](https://solace.com/try-it-now/) event broker, you can either choose the free Software version using Docker or Solace PubSub+ Cloud.

<Frame>
  <img src="/images/solace-pic1.png"/>
</Frame>
...
<Note>
Solace PubSub+ supports popular open protocols like AMQP, JMS, MQTT, REST, and WebSocket, and open APIs such as Paho and Qpid to enable interaction with the event broker. We will use the [RisingWave MQTT connector](/integrations/sources/mqtt) to read and write data from Solace.
...
<Frame>
  <img src="/images/solace-pic2.png"/>
</Frame>
