...
description: "This guide will go over how to set up a Kafka cluster on Confluent Cloud so you can connect and read data from it with RisingWave. See [Confluent](https://www.confluent.io) for more details and how to get started."
---
...
<Frame>
  <img src="/images/produce-data.png"/>
</Frame>
...
3. Add a new **service account** API key for the cluster you just created, and setup the ACL for allowing READ operation for consumer groups with `rw-consumer` (align with `group.id.prefix` in the WITH clause).

<Frame>
  <img src="/images/confluent-key-acl.png.png"/>
</Frame>
...
<Frame>
  <img src="/images/confluent-consumption.png"/>
</Frame>
