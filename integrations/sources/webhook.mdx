...
The same `webhook` table can also accept WebSocket ingest at `ws://<HOST>:4560/ingest/<database>/<schema>/<table>`. For managed RisingWave Cloud routing and usage details, see [Ingest data from WebSocket](/cloud/ingest-data-from-websocket).
