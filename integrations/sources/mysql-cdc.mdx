...
4. Modify your RDS instance and apply the modified parameter group to your database.![Select modify](/images/modify-RDS.png) ![Apply changes to database](/images/apply-to-databas.png)
