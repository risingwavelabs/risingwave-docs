...
This guide covers WebSocket ingestion in both **RisingWave Cloud** and **self-hosted RisingWave** deployments. In self-hosted deployments, WebSocket ingest requires a license and uses the frontend ingest listener directly.
...
3. For RisingWave Cloud, the tenant identifier of your project (for example, `rwc-g1huxxxxxx-mycluster`).
