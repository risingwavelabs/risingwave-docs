...
| Field                           | Notes                                                                                                                                                                                                                                                                              |
| :------------------------------ | :--------------------------- |
| _data\_format_                  | Data format. Supported formats: DEBEZIUM, UPSERT, PLAIN.                                                                                                                                                                                                                            |
...
| auto.commit.interval.ms               | properties.auto.commit.interval.ms               | int     |
...
`properties.auto.commit.interval.ms` is supported for Kafka sources and tables only. It controls how frequently Kafka consumer offsets are committed when `properties.enable.auto.commit` is enabled.
