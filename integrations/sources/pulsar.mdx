...
To monitor acknowledgment success and failure metrics for this source, see [Monitor source connector acknowledgments](/ingestion/monitor-source-connector-acks).
