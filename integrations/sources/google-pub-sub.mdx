...
For Google Pub/Sub acknowledgment behavior, checkpoint recovery, and duplicate-handling caveats, see [Source delivery semantics](/ingestion/delivery-semantics).
