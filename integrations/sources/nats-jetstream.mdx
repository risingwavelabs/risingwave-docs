...
| scan.startup.mode                | Optional. The offset mode that RisingWave will use to consume data. The supported modes are: earliest: Consume data from the earliest offset.latest: Consume data from the latest offset.timestamp: Consume data from a particular UNIX timestamp, which is specified via scan.startup.timestamp.millis.If not specified, the default value earliest will be used. |
...
| consumer.durable\_name           | Optional. Durable name for the consumer.                                                                                                                                                                                                                                                                                                                                   |
