...
For upsert sinks, duplicates are naturally handled by Kafka consumers through primary key deduplication. For append-only sinks, downstream consumers should handle potential duplicates.
