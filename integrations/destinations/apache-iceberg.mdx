...
| create_table_if_not_exists | Optional. From RisingWave 2.1, you can use this parameter to `true` or `false` and decide or not to create a table if it doesn't exist yet. |
