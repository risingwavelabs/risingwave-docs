...
<Note>
**New Snowflake v2 Sink Available**

A new enhanced Snowflake v2 sink connector is now available with additional features including automatic schema changes and improved data loading methods. See [Snowflake v2 sink documentation](/integrations/destinations/snowflake-v2) for details.

This documentation covers the original Snowflake sink connector (`connector = 'snowflake'`).
</Note>
