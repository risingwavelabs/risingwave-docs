...
|-|-|
| connector             | Required. Support GCS or Iceberg connector.|
...
| catalog.type   | Conditional. This can be set when the connector is Iceberg. The currently supported values are `storage` and `rest`.  |
