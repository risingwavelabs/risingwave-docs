...
2. Configure the following additional trusted entities for your IAM Role to allow RisingWave arn to assume the role. Please don’t click required external id to trust RisingWave arn here.
    ...
    "Statement": [
        {
            ...
            "Principal": {
                "AWS": [
                    "arn:aws:iam::600598779918:role/g1j1jcf11aejvbjhkaccqsubue-role"
                ]
            },
