...
For integration with secret management systems (like AWS Secrets Manager), you can provide the PEM-formatted private key content directly. This is the recommended approach for production environments:
