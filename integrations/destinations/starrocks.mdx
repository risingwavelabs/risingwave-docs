...
| DATETIME, VARCHAR, CHAR, STRING | TIMESTAMP WITH TIME ZONE |
| No support     | INTERVAL                                                                                          |
| No support     | STRUCT                                                                                            |
| ARRAY          | ARRAY                                                                                             |
| No support     | BYTEA                                                                                             |
...
When sinking `TIMESTAMP WITH TIME ZONE` to StarRocks, RisingWave writes the value as a UTC timestamp string without a timezone suffix.
