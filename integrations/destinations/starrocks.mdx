...
| VARCHAR, CHAR, STRING | TIMESTAMP WITH TIME ZONE |
| No support     | INTERVAL                                                                                          |
| No support     | STRUCT                                                                                            |
| ARRAY          | ARRAY                                                                                             |
| No support     | BYTEA                                                                                             |
...
When sinking `TIMESTAMP WITH TIME ZONE` to StarRocks, RisingWave writes the value as a UTC timestamp string in `YYYY-MM-DD HH:MM:SS.ffffff` format, with six fractional-second digits and no timezone suffix.
