...
## Data type mapping
Use this table to choose StarRocks column types compatible with the RisingWave types in your source table or materialized view. For details on native RisingWave data types, see [Overview of data types](/sql/data-types/overview).
