...
| CHAR, STRING | TIMESTAMP WITH TIME ZONE |
| No support     | INTERVAL                                                                                          |
| No support     | STRUCT                                                                                            |
| ARRAY          | ARRAY                                                                                             |
| No support     | BYTEA                                                                                             |
...
When sinking `TIMESTAMP WITH TIME ZONE` to StarRocks, RisingWave formats the value in the sink's configured time zone as `YYYY-MM-DD HH:MM:SS.ffffff`, with six fractional-second digits and no timezone suffix. For example, with `Asia/Shanghai`, `2018-01-26T18:30:09.453Z` is written as `2018-01-27 02:30:09.453000`.
