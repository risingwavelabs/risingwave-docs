...
This alert indicates that no barrier has been committed in your cluster for longer than the configured threshold. Data freshness can be affected while barriers remain pending.
...
If node resources are fully utilized or a backfill is running, scale out the cluster to alleviate the pressure. For more information, see [Scale a cluster manually](/cloud/scale-a-project-manually).
