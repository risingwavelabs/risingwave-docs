...
description: "You can manually control the running state of your projects or delete them."
---
...
This will halt the running streaming pipelines and release all the compute resources of the running project. While the project is paused:
