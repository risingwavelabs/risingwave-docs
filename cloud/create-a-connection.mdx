---
title: "PrivateLink connection configuration"
sidebarTitle: "PrivateLink config"
...
You need to create a cluster with the Standard plan or Advanced plan in RisingWave Cloud:
   * See [Choose a cluster plan](/cloud/choose-a-project-plan/) for more information. Please note that Trial clusters do not support PrivateLink connections.
...
1. In the [RisingWave Cloud dashboard](https://cloud.risingwave.com/dashboard), open your cluster and click **Network Access** in the cluster navigation.
...
1. In the [RisingWave Cloud dashboard](https://cloud.risingwave.com/dashboard), open your cluster and click **Network Access** in the cluster navigation. Select the **PrivateLink** tab.
