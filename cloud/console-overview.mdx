...
For security, the query log redacts password literals in `CREATE USER` and `ALTER USER` statements, including `PASSWORD` and `ENCRYPTED PASSWORD` clauses, and displays them as `[REDACTED]`.
<Frame>
