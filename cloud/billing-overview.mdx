...
RisingWave offers three pricing plans to cater to your specific needs:
...
* **Self-managed**
The Self-managed plan is designed for on-premises or Kubernetes deployments and uses annual contract pricing.
