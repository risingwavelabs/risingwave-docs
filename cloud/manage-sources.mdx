...
2. Open the cluster where you want to create the source.
3. In the cluster navigation, click **Data Catalog**.
4. Select the **Sources** tab, then click **Create source**.
5. Select the service you want to connect to.
    <Note>

    More services will be supported in future releases.

    </Note>
6. Configure the connector settings, source details, and schema according to the instructions of the guided setup.
7. Review the generated SQL statement and click **Create source** to create the source in your database.
...
1. Open the cluster and go to **Data Catalog** > **Sources**.
