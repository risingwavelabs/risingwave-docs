...
A RisingWave container was terminated due to an Out of Memory (OOM) condition in the cluster.
...
No barrier has been committed in this cluster for longer than the configured threshold.
...
Scale the compactor out. For more information, see [Scale a cluster manually](/cloud/scale-a-project-manually).
