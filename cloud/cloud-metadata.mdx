...
In the [RisingWave Cloud dashboard](https://cloud.risingwave.com/dashboard), open your cluster and click **Network Access** in the cluster navigation. Then select the **Cloud Meta** tab.

<Frame>
<img src="/images/cloud/cloud-metadata/connection-cloud-meta-v2.png" alt="Cloud Meta tab in the Network Access page of the RisingWave Cloud Console"/>
</Frame>

<Note>
Cloud metadata is only available for clusters on the **Standard** plan or above.
</Note>
