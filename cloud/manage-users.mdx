...
3. Enter the email address of the user you want to invite.
  ...
  <Note>
  An email that’s already registered on RisingWave Cloud can’t be invited again. If you want to add that user, they must delete their current account first.
  </Note>
