...
1. Go to [**Organization**](https://cloud.risingwave.com/dashboard/organization) and select the **SSO** tab.
...
<Frame>
  <img src="/images/cloud/sso/org-sso-create-v2.png"/>
</Frame>
<br/>
<Accordion
...
<Frame>
  <img src="/images/cloud/sso/org-sso-card-v2.png"/>
</Frame>
...
<Frame>
  <img src="/images/cloud/sso/org-sso-login-1-v2.png"/>
</Frame>
2. Enter your work email and click **Log in**.
<Frame>
  <img src="/images/cloud/sso/org-sso-login-2-v2.png"/>
</Frame>
