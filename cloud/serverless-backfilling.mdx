...
3. After the materialized view is created successfully, the materialized view is migrated to its steady-state resource group for normal streaming execution.
...
- How temporary backfiller resource groups interact with the materialized view's steady-state resource group
