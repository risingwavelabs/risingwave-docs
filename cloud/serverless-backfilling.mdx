...
4. Enable **Serverless backfilling**, then click **Configure** to set the Backfiller SKU and replicas described below.

The following screenshot shows the **Serverless backfilling** panel on the **Backfillings** tab, including its SKU and replica settings and an active backfill job:
