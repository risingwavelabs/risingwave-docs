...
Yes. You can invite others to join your organization and share your projects and other resources with them. See [Organization](/cloud/organization-overview/) for more information.
  ...
  <Accordion title="How do I report bugs or issues with RisingWave Cloud?">
For RisingWave Cloud issues, contact our support team at [cloud-support@risingwave-labs.com](mailto:cloud-support@risingwave-labs.com). For general RisingWave issues or questions, see our guide on [how to report and reproduce issues](/troubleshoot/report-reproduce-issues).
  </Accordion>
</AccordionGroup>
