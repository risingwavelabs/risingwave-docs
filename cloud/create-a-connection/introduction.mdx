...
>
  ...
  <Frame>
  <img src="/images/cloud/create-a-connection/aws-endpoint-service-name-9f11a27d9c84d388e08bc13ac46a0ec6.png"/>
</Frame>
</Accordion>
...
You can find it in the [Google Cloud Console](https://console.cloud.google.com/) → **Network services** → **Private Service Connect**.
  <Frame>
  <img src="/images/cloud/create-a-connection/gcp-service-attachment-8a7630991fc4e82913c6872f09a58fee.png"/>
</Frame>
</Accordion>
...
<Frame>
  <img src="/images/cloud/create-a-connection/azure-resource-id-5f61ffad38b3319ac8e0e291f61caf34.png"/>
</Frame>
