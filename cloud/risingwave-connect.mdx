...
<Frame>
  <img src="/images/rw_connect_overview-v2.png" />
</Frame>
...
1. Go to the [RisingWave Cloud dashboard](https://cloud.risingwave.com/dashboard) and open a cluster.
2. In the cluster navigation, click **Data Catalog**.
3. Use the **Sources** tab to create sources, or the **Sinks** tab to create sinks.
