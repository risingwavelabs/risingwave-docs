...
You have to [add a payment method](/cloud/manage-payment-methods/) before you can access the **Standard** plan.
  </Tab>
  <Tab title="Advanced plan">
The **Advanced** plan is specifically designed for our enterprise customers. You can either utilize our hosted service or [Bring Your Own Cloud](/cloud/project-byoc/). This plan provides unparalleled flexibility, allowing you to customize everything from the underlying infrastructure and project configurations to the pricing plan, which may include exclusive discounts.
...
For information on your service fee, see [Pricing](/cloud/pricing/).
