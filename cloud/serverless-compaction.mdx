...
You may prefer fixed compactor sizing in [Scale a cluster manually](/cloud/scale-a-project-manually) when:
...
Serverless Compaction is configured from the **Compactions** section of your cluster's **Resources** page, where it is listed as **Auto-compaction**.

1. Open your cluster in RisingWave Cloud.
2. Select **Resources** in the cluster navigation.
...
<AccordionGroup>
  <Accordion title="Is Serverless Compaction available on my cluster?">
