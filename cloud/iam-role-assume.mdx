...
To view and manage the IAM role ARNs that are authorized to access your cluster's resources via IAM Assume Role, go to the [RisingWave Cloud dashboard](https://cloud.risingwave.com/dashboard), open your cluster, click **Network Access** in the cluster navigation, and select the **Allowed Principals** tab.
