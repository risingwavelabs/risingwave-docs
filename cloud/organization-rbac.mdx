...
To grant a role, go to [**Organization**](https://cloud.risingwave.com/dashboard/organization) and select the **Access** tab. Add or update the access entry for the user or service account.
