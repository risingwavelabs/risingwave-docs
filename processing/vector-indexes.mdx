...
| `ef_search` | Controls the accuracy/speed trade-off for nearest neighbor searches. Can be set via the session variable `batch_hnsw_ef_search` (default 40). | HNSW |
...
- [Vector data type](/sql/data-types/vector)
