...
<Card title="Vector Indexes" icon="vector-square" iconType="solid" href="/sql/commands/sql-create-vector-index">
Create specialized indexes for efficient vector similarity search operations.
</Card>
