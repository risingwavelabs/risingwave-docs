...
On RisingWave Cloud, you can offload backfill work to dedicated, auto-scaling backfiller nodes that are separate from your streaming cluster. This reduces contention between large backfill jobs and live streaming workloads.
...
2. Create the materialized view with the `cloud.serverless_backfill_enabled = true` option:
