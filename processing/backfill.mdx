...
1. Enable it under **Resources -> Backfillings** in the RisingWave Cloud console.
...
For details on configuring backfiller SKU, replicas, and cost controls, see [Serverless backfilling](/cloud/serverless-backfilling).
