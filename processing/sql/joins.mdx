...
<Note>
Added in v2.5.0. It is currently in **[technical preview](/changelog/product-lifecycle#product-release-lifecycle)** stage. There are some known performance issues and bugs tracked here: https://github.com/risingwavelabs/risingwave/issues/20408.
</Note>
