...
```shell
wget https://github.com/risingwavelabs/risingwave/releases/download/v0.19.0/risingwave-v0.19.0-x86_64-unknown-linux.tar.gz
```
...
```shell
tar xvf risingwave-v0.19.0-x86_64-unknown-linux.tar.gz
```
