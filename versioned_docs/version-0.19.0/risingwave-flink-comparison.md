...
We periodically update this article to keep up with the rapidly evolving landscape. As of our most recent update in June 2023, we are comparing Apache Flink 1.16.1 and RisingWave 0.19.0.

## Summary

| |Apache Flink|	RisingWave|
|---|---|---|
|Version	|1.16.1|	0.19.0|
