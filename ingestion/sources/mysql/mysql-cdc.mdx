...
For MySQL CDC consistency, checkpoint recovery, snapshot behavior, and binlog-retention caveats, see [Source delivery semantics](/ingestion/delivery-semantics).
