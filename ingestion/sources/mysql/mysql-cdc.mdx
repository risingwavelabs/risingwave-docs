...
For MySQL 8 servers that use the default `caching_sha2_password` authentication plugin, RisingWave automatically enables public key retrieval for the embedded Debezium connection. You do not need to add an extra Debezium property for this.
