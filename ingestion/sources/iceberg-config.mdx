...
RisingWave supports using the Iceberg source with AWS S3 Tables. The following parameters configure the connection to S3 Tables. For more information, see [Use Amazon S3 Tables](/iceberg/overview#use-amazon-s3-tables).
