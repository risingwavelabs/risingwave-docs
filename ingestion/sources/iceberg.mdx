...
<Note>
Added in version 2.3. For sources created before 2.3, you need to re-create the source to create a streaming job on top of it.
</Note>

You can create a materialized view or a sink on top of an Iceberg source to incrementally transform iceberg data,
just like any other sources.
