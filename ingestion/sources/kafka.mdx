...
|`offset`	|`VARCHAR`	|The offset in the partition. Since v2.6.0, when querying with a timestamp beyond the latest message, it starts from the latest offset instead of resetting to the earliest. |
