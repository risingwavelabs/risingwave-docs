...
For MongoDB CDC consistency, checkpoint recovery, and change-stream retention caveats, see [Source delivery semantics](/ingestion/delivery-semantics).
