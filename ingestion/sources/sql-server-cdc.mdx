...
For SQL Server CDC consistency, checkpoint recovery, snapshot behavior, and transactional caveats, see [Source delivery semantics](/ingestion/delivery-semantics).
