...
For PostgreSQL CDC consistency, checkpoint recovery, snapshot behavior, and WAL-retention caveats, see [Source delivery semantics](/ingestion/delivery-semantics).
