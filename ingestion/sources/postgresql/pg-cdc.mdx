...
To ingest PostgreSQL user-defined composite types, set:

```sql
debezium.include.unknown.datatypes = 'true'
```

Composite columns are ingested as `VARCHAR` values in PostgreSQL's native text form, such as `(USD,12.34)`.
...
<Note>
To ingest PostgreSQL user-defined composite types, set `debezium.include.unknown.datatypes = 'true'`. RisingWave maps composite columns to `VARCHAR` and stores their values in PostgreSQL's native text form, such as `(a,b,c)`.
</Note>
...
| User-defined composite types                         | CHARACTER VARYING\*                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| DATE                                                 | DATE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
