...
<Tip>
**Try our SQL generator tool!** We've built an interactive tool to help you generate SQL statements for connecting to data sources. Check it out at [https://sql.risingwave.com/source/postgres-cdc](https://sql.risingwave.com/source/postgres-cdc).
</Tip>
...
Create a CDC table with parallelized backfill enabled for better performance on large tables:
