...
For Kafka sources, tables, sinks, and connections, you can update the following SSL properties online without recreating the object:
...
| `properties.ssl.ca.pem`                | CA certificate string in PEM format used to verify the Kafka broker's certificate.                                                                                                                                       | Yes (for SSL)        |
| `properties.ssl.certificate.location`  | Path to the client's SSL certificate file. Example: `'/path/to/client.pem'`                                                                                                                                  | Conditional            |
| `properties.ssl.certificate.pem`       | Client certificate string in PEM format.                                                                                                                                                                                  | Conditional          |
| `properties.ssl.key.location`          | Path to the client's SSL private key file. Example: `'/path/to/client.key'`                                                                                                                                      | Conditional            |
| `properties.ssl.key.pem`               | Client private key string in PEM format.                                                                                                                                                                                 | Conditional          |
