...
| `properties.reconnect.backoff.ms`     | The initial backoff time in milliseconds before reconnecting to a broker after the connection closes. The backoff increases exponentially until `properties.reconnect.backoff.max.ms` is reached. Default: `100`.                                                                     | int     |
| `properties.reconnect.backoff.max.ms` | The maximum backoff time in milliseconds before reconnecting to a broker after the connection closes. Default: `10000`.                                                                                                                                                              | int     |
| `properties.retry.backoff.ms`         | The initial backoff time in milliseconds before retrying a failed protocol request. The backoff increases exponentially until `properties.retry.backoff.max.ms` is reached. Default: `100`.                                                                                           | int     |
| `properties.retry.backoff.max.ms`     | The maximum backoff time in milliseconds before retrying a failed protocol request. Default: `1000`.                                                                                                                                                                                | int     |
| `properties.socket.connection.setup.timeout.ms` | The maximum time in milliseconds allowed for broker connection setup, including TCP setup and SSL or SASL handshakes. Default: `30000`.                                                                                                                                     | int     |
...
The following source-only consumer property is also supported:

| Parameter                             | Description                                                                                                                                                                                                                                                                              | Type    |
| :------------------------------------ | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------ |
| `properties.auto.commit.interval.ms`  | The frequency in milliseconds at which the Kafka consumer commits offsets when `properties.enable.auto.commit` is enabled. This option applies to Kafka sources and tables, not Kafka sinks. Default: `5000`.                                                                        | int     |
