...
| [MySQL CDC](/ingestion/sources/mysql/mysql-cdc) | 5.7, 8.0 | [Debezium JSON](#debezium-json) (T) |
| [SQL Server CDC](//ingestion/sources/sql-server-cdc) | 2019, 2022 | [Debezium JSON](#debezium-json) (T) |
| [MongoDB CDC](//ingestion/sources/mongodb-cdc) |  | [Debezium Mongo JSON](#debezium-mongo-json) (T) |
| [CDC via Kafka](/ingestion/cdc-with-risingwave) |  | [Debezium JSON](#debezium-json) (T), [Maxwell JSON](#maxwell-json) (T), [Canal JSON](#canal-json) (T) |
