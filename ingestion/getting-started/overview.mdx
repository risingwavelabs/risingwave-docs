...
RisingWave supports various data formats and encodings. See [Supported data formats and encodings](/ingestion/getting-started/data-formats-and-encoding-options) for details.

## Next steps

*   Explore the [Supported data sources](/ingestion/getting-started/sources) and [Supported data formats and encodings](/ingestion/getting-started/data-formats-and-encoding-options).
*   Learn how to connect to specific sources using the individual connector guides (e.g., [Connect to Kafka](/ingestion/sources/apache-kafka-guide)).
