...
RisingWave supports various data formats and encodings. See [Data formats and encoding options](/ingestion/getting-started/data-formats-and-encoding-options) for details.

## Next steps

*   Explore the [Sources](/ingestion/getting-started/sources) and [Data formats and encoding options](/ingestion/getting-started/data-formats-and-encoding-options).
