...
| [Load generator](/ingestion/generate-test-data) | Built-in             |

For information on supported data formats and encodings, and whether you need to use `CREATE SOURCE` or `CREATE TABLE` with each format, see [Supported data formats and encoding options](/ingestion/getting-started/supported-formats-and-encoding).