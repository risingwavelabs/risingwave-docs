...
- **PostgreSQL**: RisingWave embeds the [Debezium Embedded Engine](https://debezium.io/documentation/reference/development/engine.html) in-process and reads PostgreSQL write-ahead logs (WAL) via logical replication, without requiring a Kafka cluster or Kafka Connect worker.
