...
After [connecting your RisingWave clusters](connect-risingwave-clusters.md) to Wavekit, you can use the UI to view their status and access several operational tools provided on the "Cluster Details" page.
