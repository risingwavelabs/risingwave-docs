...
With your clusters connected, you can now proceed to [Manage and monitor clusters](/wavekit/  manage-monitor-clusters) or start [Using the SQL Console](/wavekit/use-sql-console).