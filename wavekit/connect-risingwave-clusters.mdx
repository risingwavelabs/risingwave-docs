...
<Info>Deleting a cluster connection from WaveKit *only removes its configuration from WaveKit*. It does not affect, stop, or delete your actual RisingWave cluster.</Info>
