---
title: "Ingest from Iceberg tables"
sidebarTitle: "Ingest from Iceberg tables"
description: "Learn how to use the Iceberg source in RisingWave to ingest data from your existing Iceberg tables."
---

This guide explains how to ingest data from existing Iceberg tables into RisingWave. Use this when you have Iceberg tables managed by external systems and want to use them as a streaming source for real-time processing in RisingWave.

To ingest data from an Iceberg table, you create an Iceberg source. This involves two main steps:
...
```sql
-- Ingest from tables written by Spark
...
- **Set up a sink**: Deliver processed data back to Iceberg with [Deliver to Iceberg](/iceberg/deliver-to-iceberg).
