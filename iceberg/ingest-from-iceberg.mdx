...
<Note>
Do not define column types in the `CREATE TABLE` statement. RisingWave automatically infers the schema from the Iceberg table. Only specify the primary key constraint if your Iceberg table has one.
</Note>
