...
## Optional: Enable credential vending

Lakekeeper supports credential vending when configured with valid object storage credentials.
For more information on how vended credentials work, see [Vended credentials](/iceberg/catalogs/rest#vended-credentials).