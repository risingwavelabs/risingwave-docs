...
<Note>
For Google Cloud Lakehouse Iceberg REST catalogs, set `catalog.header = 'x-goog-user-project=PROJECT_ID'` to specify the billing project. If you use `vended_credentials = true`, also set `catalog.io_impl = 'org.apache.iceberg.gcp.gcs.GCSFileIO'`.
</Note>
