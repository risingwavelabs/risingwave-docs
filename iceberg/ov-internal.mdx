...
- **Built-in catalog**: Uses RisingWave’s internal PostgreSQL-compatible metastore as a JDBC-compliant catalog. See [Built-in catalog](/iceberg/catalogs/internal).
