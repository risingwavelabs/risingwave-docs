...
![image.png](/iceberg/new/images/external-iceberg-tables.png)
...
![image.png](/iceberg/new/images/internal-iceberg-tables.png)
...
- **JDBC hosted catalog** — backed by RisingWave’s internal PostgreSQL-compatible metastore. See [JDBC hosted catalog](/iceberg/iceberg-catalog-jdbc)
- **REST hosted catalog** — powered by Lakekeeper and compatible with the Iceberg REST catalog API. See [REST hosted catalog](/iceberg/iceberg-catalog-rest)
