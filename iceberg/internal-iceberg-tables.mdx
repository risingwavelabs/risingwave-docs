...
You can also set the optional `commit_checkpoint_interval` parameter to control the commit frequency. The default is `60`, which means RisingWave commits data every 60 checkpoints. You can adjust this value based on your requirements.
