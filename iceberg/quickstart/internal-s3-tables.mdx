...
<Tip>
If you don’t have a table bucket yet, you can create one with AWS CLI (S3 Tables must be available in your region).
...
This command opens an interactive `psql` session with variables preloaded. After it connects, **paste the SQL blocks below**.
