...
The Iceberg table you created is not locked into RisingWave. To demonstrate this, let's query the `customer_profile` table using a different engine, DuckDB.
