...
RisingWave also supports compaction for Iceberg sink. For details, see [
Compaction for Iceberg sink](/iceberg/byoi/write-to-iceberg#compaction-for-iceberg-sink).
