...
Optionally, compaction jobs can record metadata, such as the last compacted snapshot ID and timestamp in `table.metadata.properties` for tracking and monitoring.
