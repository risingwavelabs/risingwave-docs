...
| Apr 2025 | Support AWS S3 Table, Snowflake Catalog, Databricks Catalog Integration |
...
| Data Source Support | [Rich](https://docs.risingwave.com/ingestion/sources) (CDC, message queues, batch, webhook, etc) | Rich | Rich | Richest |
...
| Periodic loading (append-only) | Soon to support (v2.7, early Nov, 2025) | Partially supported (cron job + ad-hoc Spark procedure) | Not Supported |
| Periodic loading (mutable, CoW) | Soon to support (v2.7, early Nov, 2025) | Partially supported (cron job + ad-hoc Spark procedure) | Not Supported |
| Periodic loading (mutable, MoR) | Soon to support (v2.7, early Nov, 2025) | Not Supported | Not Supported |
| Continuous loading (append-only) | Supported | Partially Supported (with Spark Streaming and Deduplication) | Supported |
| Continuous loading (mutable, CoW) | Supported | Not Supported | Not Supported |
| Continuous loading (mutable, MoR) | Not Supported | Not Supported | Not Supported |
