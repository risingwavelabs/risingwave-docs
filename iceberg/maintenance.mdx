...
In addition to automatic background maintenance, you can trigger compaction and snapshot expiration manually using the [`VACUUM`](/sql/commands/sql-vacuum) command.
