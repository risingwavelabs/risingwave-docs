...
| `compaction_interval_sec` | Optional. The interval in seconds between data file compaction runs. It does not control manifest rewrite or snapshot expiration. Default: `3600`. |
