...
| `catalog.rest.signing_region` | For SigV4 REST catalogs (e.g., Amazon S3 Tables, SeaweedFS): the AWS region for signing requests. |
| `catalog.rest.signing_name` | For SigV4 REST catalogs (e.g., Amazon S3 Tables, SeaweedFS): the service name for signing requests. |
| `catalog.rest.sigv4_enabled` | For SigV4 REST catalogs (e.g., Amazon S3 Tables, SeaweedFS): enables SigV4 signing. Must be `true`. |
