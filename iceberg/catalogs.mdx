...
| `enable_config_load` | For S3 or GCS file I/O in self-hosted deployments, set to `true` to allow credential loading from the environment or local configuration. This does not configure Java catalog authentication. |
