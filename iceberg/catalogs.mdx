...
- **Ingest from external tables**: See [Ingest data from Iceberg sources](/iceberg/ingest-from-iceberg).
- **Deliver to external tables**: See [Deliver data to Iceberg sinks](/iceberg/deliver-to-iceberg).
