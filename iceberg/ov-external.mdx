...
For details, see [Ingest data from external Iceberg tables](/iceberg/read-from-iceberg).
...
For details, see [Deliver data to external Iceberg tables](/iceberg/write-to-iceberg).
