...
This guide shows how to sink data from RisingWave into Databricks managed Iceberg tables using Unity Catalog. With this setup, Databricks manages the Iceberg metadata, and RisingWave writes data directly into these tables.
