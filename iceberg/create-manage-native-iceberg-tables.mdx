...
sidebarTitle: "Create & manage tables"
...
RisingWave also supports compaction for Iceberg sinks. For details, see [Compaction for Iceberg sink](/iceberg/write-to-iceberg#compaction-for-iceberg-sink).
