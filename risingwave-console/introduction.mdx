...
| **How to get it**     | Included automatically — no extra setup.                                     | **Premium feature.** Contact [sales@risingwave-labs.com](mailto:sales@risingwave-labs.com) to obtain the image or binary. |
...
- If you just installed RisingWave and want to look inside the cluster — open the **[built-in UI](/risingwave-console/built-in-ui)** at `http://localhost:5691`. There is nothing to install.
...
See **[Built-in UI](/risingwave-console/built-in-ui)** for details on how to access and configure it.
...
RisingWave Console is **not included with RisingWave**. To obtain the image or binary and discuss version compatibility, contact RisingWave Labs at [sales@risingwave-labs.com](mailto:sales@risingwave-labs.com).

Once you have access, continue with:

- [Prerequisites](/risingwave-console/prerequisites)
- [Installation and setup](/risingwave-console/installation-setup)
- [Connect to your RisingWave clusters](/risingwave-console/connect-risingwave-clusters)
- [Manage and monitor clusters](/risingwave-console/manage-monitor-clusters)
- [Use the SQL Console](/risingwave-console/use-sql-console)
