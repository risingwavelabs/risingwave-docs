...
| `v2.1`  | Dec 7, 2024  | April 13, 2025                                |
| `v2.2`  | Feb 11, 2025 | May 21, 2025 |
| `v2.3`  | April 13, 2025  | July 29, 2025 |
...
*   The upgrade process for deprecated versions is automated using maintenance windows. When your project is running a deprecated version, RisingWave Cloud schedules an upgrade to a supported version and executes it during your configured maintenance window. See [Maintenance windows](/cloud/maintenance-window) for details on how to configure your window, view upcoming and past maintenance operations, and opt out of automated upgrades.
*   If automated upgrades are disabled for your project, the RisingWave Cloud SRE team will coordinate with you regarding necessary upgrades to stay within supported versions.
