...
description: "This topic describes the product release lifecycle and feature deprecation policy of RisingWave, and provides a list of all features in the public preview stage."
---
...
Over time, features may also be deprecated and eventually removed from the product. To ensure transparency and minimize disruption, we have established a clear Feature Deprecation Policy. This policy outlines how we communicate and manage feature deprecations, which you can find detailed below.
