...
This document describes the lifecycle of *individual features* within RisingWave. For information on the lifecycle and deprecation of *RisingWave software versions*, please see the [RisingWave version deprecation policy](/changelog/version-deprecation).
