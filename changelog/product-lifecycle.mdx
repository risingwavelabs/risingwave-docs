...
This document describes the lifecycle of *individual features* within RisingWave. For information on the lifecycle and deprecation of *RisingWave software versions*, please see the [RisingWave version deprecation policy](/changelog/version-deprecation).  *(Replace `/path/to/version-deprecation-policy` with the actual path)*
...
RisingWave follows semantic versioning. For more information about versioning, support, and release lifecycle, refer to [RisingWave release and support lifecycle](/changelog/release-support-lifecycle).

## Feature deprecation policy

This section outlines the policy for deprecating *individual features*. 
For information on the deprecation of entire RisingWave *software versions*, please see the [RisingWave version deprecation policy](/changelog/version-deprecation).
