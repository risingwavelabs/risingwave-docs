...
- Improves meta snapshot restore efficiency by decoding only the required Hummock sequence data from the latest snapshot when rewriting sequence values, instead of decoding full snapshot metadata. [#26193](https://github.com/risingwavelabs/risingwave/pull/26193)
