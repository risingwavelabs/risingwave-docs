...
- Compaction output SST filters now default to block-based layout for all non-L0 levels. L5 and L6 now default to `xor8` filters, while L0 keeps the existing automatic layout decision and `xor16` filter kind. [#25853](https://github.com/risingwavelabs/risingwave/pull/25853)
