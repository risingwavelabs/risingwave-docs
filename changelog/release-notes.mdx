...
- Prevents subscription cursors from requesting invalid inverted table change-log epoch ranges when the table's committed epoch has not caught up yet, avoiding a possible meta-node crash and making the cursor wait for a newer committed epoch instead. [#26478](https://github.com/risingwavelabs/risingwave/pull/26478)
