...
- System catalog:
    ...
    - Adds system catalog `rw_cdc_progress` to track the progress of CDC tables with parallelized backfill enabled. [#22943](https://github.com/risingwavelabs/risingwave/pull/22943)
...
- Supports parallelized CDC backfill for PostgreSQL CDC tables to improve data ingestion performance. Enable with new table options: `backfill.parallelism`, `backfill.num_rows_per_split`, and `backfill.as_even_splits`. [#22536](https://github.com/risingwavelabs/risingwave/pull/22536)
- Adds progress tracking for parallelized CDC backfill with enhanced state monitoring. [#22943](https://github.com/risingwavelabs/risingwave/pull/22943)
