...
- After a meta restart, exactly-once sink writers no longer replay epochs whose pre-commit metadata was already persisted, preventing duplicate-key errors during recovery. [#25690](https://github.com/risingwavelabs/risingwave/pull/25690)
- **PostgreSQL CDC**:
