...
This section will be updated with notable changes planned for v3.1.0.

</Update>

<Update label="v3.0.0" description="Released on 2026-06-11">

## SQL features

- SQL commands:
    - Supports `SHOW CURSORS` and subscription cursors on all frontend nodes. [#24107](https://github.com/risingwavelabs/risingwave/pull/24107)
    - Supports `DROP SECRET CASCADE`. [#24581](https://github.com/risingwavelabs/risingwave/pull/24581)
...
- Supports PostgreSQL 18 for PostgreSQL CDC sources. [#24765](https://github.com/risingwavelabs/risingwave/pull/24765)
- Supports the HTTP sink connector. [#25396](https://github.com/risingwavelabs/risingwave/pull/25396)
- Supports exactly-once semantics for Delta Lake sinks. [#25159](https://github.com/risingwavelabs/risingwave/pull/25159)
- Supports Protobuf encoding for MQTT sources. [#25403](https://github.com/risingwavelabs/risingwave/pull/25403)
