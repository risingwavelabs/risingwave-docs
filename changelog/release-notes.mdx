...
- Exactly-once sink coordination now skips recovered pending epochs after a meta restart, preventing duplicate-key errors when sink writers reconnect during recovery. [#25690](https://github.com/risingwavelabs/risingwave/pull/25690)
- **PostgreSQL CDC**:
