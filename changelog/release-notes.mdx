...
- Exactly-once sinks no longer replay epochs whose pre-commit metadata was already persisted before a meta restart, preventing duplicate-key recovery errors in sink coordination. [#25690](https://github.com/risingwavelabs/risingwave/pull/25690)
