...
- Prevents an unchanged `ALTER SINK ... CONNECTOR WITH (...)` from crashing a compute node when the sink uses a commit-decoupled KV log store. [#26412](https://github.com/risingwavelabs/risingwave/pull/26412)
