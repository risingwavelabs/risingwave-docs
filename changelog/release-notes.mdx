...
- Fixes an internal stream planning issue that could cause snapshot backfill over materialized views with wider storage keys to fail with duplicate join-state insertion. [#25783](https://github.com/risingwavelabs/risingwave/pull/25783)
