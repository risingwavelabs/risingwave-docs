...
- Adds session variable `streaming_join_encoding` to switch join encoding type between `memory_optimized` and `cpu_optimized`. [#22416](https://github.com/risingwavelabs/risingwave/pull/22416)
