...
- Improves meta snapshot restore efficiency by decoding only the `hummock_sequences` section from the latest snapshot when RisingWave rewrites sequence values during restore. [#26193](https://github.com/risingwavelabs/risingwave/pull/26193)
