...
- Fixes Iceberg Engine table creation with `enable_compaction = false` when automatic sink schema changes are not licensed. Adding a column still requires the license feature. [#26545](https://github.com/risingwavelabs/risingwave/pull/26545)
