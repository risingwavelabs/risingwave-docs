...
- Supports using HashiCorp Vault as secret backend with Token or AppRole authentication methods. [#22627](https://github.com/risingwavelabs/risingwave/pull/22627)
