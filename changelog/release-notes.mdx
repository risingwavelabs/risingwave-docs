...
- Allows Kafka SSL certificate, key, and CA settings to be altered without recreating the source, sink, or connection. [#25717](https://github.com/risingwavelabs/risingwave/pull/25717)
