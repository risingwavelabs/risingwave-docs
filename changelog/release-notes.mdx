...
`docker run -it --pull=always -p 4566:4566 -p 5691:5691 risingwavelabs/risingwave:v3.0.3-standalone single_node`
...
- System catalog:
    ...
    - Adds system catalog `rw_streaming_job_config` to inspect per-streaming-job configuration overrides. [#23914](https://github.com/risingwavelabs/risingwave/pull/23914)
