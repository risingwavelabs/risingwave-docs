...
- Fixes an issue where compaction group rewrites could leave stale write-stop limits in place after merge, split, or normalize-split operations reduced L0 sub-levels. [#25813](https://github.com/risingwavelabs/risingwave/pull/25813)
