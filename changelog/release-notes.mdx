...
- Fixed `DROP SCHEMA ... CASCADE` failures that could occur after replacing a sink with `REPLACE SINK`. [#26266](https://github.com/risingwavelabs/risingwave/pull/26266)
