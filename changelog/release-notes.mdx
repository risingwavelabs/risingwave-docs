...
- Sink decoupling now keeps synced log store progress independent from downstream backpressure, so slow or blocked downstream sinks no longer stall upstream polling for decoupled sinks. [#24303](https://github.com/risingwavelabs/risingwave/pull/24303)
