...
| Go         | [pgx](https://pkg.go.dev/github.com/jackc/pgx/v5). See the [example guide](sdks/go.mdx).  | v5.4.3                |
| Go         | [pq](https://github.com/lib/pq)                                                                              |                       |
| Java       | [JDBC](https://jdbc.postgresql.org/). See the [example guide](/sdks/java.md).             | 42.5.4                |
| JavaScript | [pg](https://www.npmjs.com/package/pg). See the [example guide](/sdks/nodejs.md).         | 8.11.3                |
| Python     | [psycopg2](https://pypi.org/project/psycopg2/). See the [example guide](/sdks/python.md). |                       |
| Python     | [psycopg3](https://pypi.org/project/psycopg/)                                                                |                       |
| Ruby       | [pg](https://github.com/ged/ruby-pg). See the [example guide](/sdks/ruby.md).             | 1.5.6                 |
