...
<Note>
We recommend using `risingwave_dev_dashboard` for monitoring. `risingwave_dashboard` is also available. The dev dashboard is better organized and more comprehensive.
</Note>
