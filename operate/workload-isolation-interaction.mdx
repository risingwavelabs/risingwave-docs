---
title: "Workload isolation and interaction in RisingWave"
...
1.  Baseline database isolation: Core improvements providing inherent resilience between databases by default.
...
## Cross-database queries (Interacting across boundaries)
...
*   [`CREATE SUBSCRIPTION`](/sql/commands/sql-create-subscription)
