...
| snapshot\_backfill\_finish\_max\_lagged\_barriers | The maximum number of lagged barriers allowed when merging a snapshot backfill job into the database graph. Defaults to `100`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
