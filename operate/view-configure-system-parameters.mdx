...
| :----------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| barrier\_interval\_ms                      | The time interval of the periodic barriers. This setting can also be configured per database for finer control over latency and resource usage. See [`CREATE DATABASE`](/sql/commands/sql-create-database) for details.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| checkpoint\_frequency                      | Specify the number of barriers for which a checkpoint will be created. The value must be a positive integer. This setting can also be configured per database to better accommodate diverse workloads. See [`CREATE DATABASE`](/sql/commands/sql-create-database) for details.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
