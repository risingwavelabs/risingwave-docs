...
Returns the first argument where the second argument (comparison value) is the largest.
...
Returns the first argument where the second argument (comparison value) is the smallest.
