...
description: "The `GROUP BY` clause groups rows in a table with identical data, thus eliminating redundancy in the output and aggregates that apply to these groups."
---
...
| product\_category | product\_subcategory | region | total\_sales |
| ----------------- | -------------------- | ------ | ------------ |
