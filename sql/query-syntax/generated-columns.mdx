...
To create a generated column, use the `AS <generation_expression>` clause in [CREATE TABLE](/docs/current/sql-create-table/) or [CREATE SOURCE](/docs/current/sql-create-source/) statements, for example:
