...
To create a generated column, use the `AS <generation_expression>` clause in [CREATE TABLE](/sql/commands/sql-create-table) or [CREATE SOURCE](/docs/current/sql-create-source/) statements, for example:
