...
| _sort\_expression_     | Values can be:Output column namesOutput column ordinal numbersHidden select expressionsArbitrary expressions, including scalar subqueries                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
