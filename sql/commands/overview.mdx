...
<CardGroup cols={2}>
  ...
  <Card title="ALTER DEFAULT PRIVILEGES" icon="user-check" iconType="solid" href="/sql/commands/sql-alter-default-privileges">
  ...
  <Card title="ALTER FRAGMENT" icon="sliders" iconType="solid" href="/sql/commands/sql-alter-fragment">
    Modify the properties of streaming fragments.
  </Card>
  ...
  <Card title="COPY" icon="copy" iconType="solid" href="/sql/commands/sql-copy">
    Export query results to standard output.
  </Card>
  ...
  <Card title="CREATE SUBSCRIPTION" icon="bell" iconType="solid" href="/sql/commands/sql-create-subscription">
    Create a subscription to real-time updates.
  </Card>
  ...
  <Card title="DROP SUBSCRIPTION" icon="bell" iconType="solid" href="/sql/commands/sql-drop-subscription">
  ...
  <Card title="EXPLAIN ANALYZE" icon="magnifying-glass-plus" iconType="solid" href="/sql/commands/sql-explain-analyze">
...
<Card title="GRANT" icon="key" iconType="solid" href="/sql/commands/sql-grant">
  ...
  <Card title="REFRESH TABLE" icon="rotate-right" iconType="solid" href="/sql/commands/sql-refresh-table">
    Trigger a refresh operation for tables manually.
  </Card>
  <Card title="REPLACE SINK" icon="arrows-rotate" iconType="solid" href="/sql/commands/sql-replace-sink">
  ...
  <Card title="SET DML_WAIT_PERSISTENCE" icon="hourglass-half" iconType="solid" href="/sql/commands/sql-set-dml-wait-persistence">
    Make DML statements wait for checkpoint persistence before returning.
  </Card>
  ...
  <Card title="SHOW CREATE SINK" icon="arrow-right-from-bracket" iconType="solid" href="/sql/commands/sql-show-create-sink">
    Show the query used to create the specified sink.
  </Card>
  <Card title="SHOW CREATE SOURCE" icon="database" iconType="solid" href="/sql/commands/sql-show-create-source">
  ...
  <Card title="SHOW CURSORS" icon="arrow-pointer" iconType="solid" href="/sql/commands/sql-show-cursors">
    Show all cursors in the current session.
  </Card>
  <Card title="SHOW DATABASES" icon="database" iconType="solid" href="/sql/commands/sql-show-databases">
    Show existing databases.
  </Card>
  <Card title="SHOW FUNCTIONS" icon="code" iconType="solid" href="/sql/commands/sql-show-functions">
    Show all user-defined functions.
  </Card>
  <Card title="SHOW INDEXES" icon="list-ol" iconType="solid" href="/sql/commands/sql-show-indexes">
    Show existing indexes from a particular table.
  </Card>
  <Card title="SHOW INTERNAL TABLES" icon="table" iconType="solid" href="/sql/commands/sql-show-internal-tables">
    Show internal tables to learn about the existing internal states.
  </Card>
  <Card title="SHOW JOBS" icon="bars-progress" iconType="solid" href="/sql/commands/sql-show-jobs">
    Show all streaming jobs.
  </Card>
  <Card title="SHOW MATERIALIZED VIEWS" icon="table" iconType="solid" href="/sql/commands/sql-show-mv">
    Show existing materialized views.
  </Card>
  <Card title="SHOW PARAMETERS" icon="sliders" iconType="solid" href="/sql/commands/sql-show-parameters">
    Show the details of the system parameters.
  </Card>
  <Card title="SHOW PROCESSLIST" icon="list" iconType="solid" href="/sql/commands/sql-show-processlist">
    Display system current workload.
  </Card>
  <Card title="SHOW SCHEMAS" icon="folder-tree" iconType="solid" href="/sql/commands/sql-show-schemas">
    Show existing schemas.
  </Card>
  <Card title="SHOW SECRETS" icon="key" iconType="solid" href="/sql/commands/sql-show-secrets">
    Show all secrets.
  </Card>
  <Card title="SHOW SINKS" icon="arrow-right-from-bracket" iconType="solid" href="/sql/commands/sql-show-sinks">
    Shows all sinks.
  </Card>
  <Card title="SHOW SOURCES" icon="database" iconType="solid" href="/sql/commands/sql-show-sources">
    Show existing sources.
  </Card>
  <Card title="SHOW SUBSCRIPTIONS" icon="bell" iconType="solid" href="/sql/commands/sql-show-subscriptions">
    Show all subscriptions.
  </Card>
  <Card title="SHOW SUBSCRIPTION CURSORS" icon="arrow-pointer" iconType="solid" href="/sql/commands/sql-show-subscription-cursors">
    Show all subscription cursors in the current session.
  </Card>
  <Card title="SHOW TABLES" icon="table" iconType="solid" href="/sql/commands/sql-show-tables">
    Show existing tables.
  </Card>
  <Card title="SHOW VIEWS" icon="eye" iconType="solid" href="/sql/commands/sql-show-views">
    Show existing views.
  </Card>
  <Card title="START TRANSACTION" icon="play" iconType="solid" href="/sql/commands/sql-start-transaction">
    Start a transaction.
  </Card>
