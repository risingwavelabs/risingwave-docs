...
<Note>
For advanced operational scenarios, you can also use `risectl` commands to update source properties. See [Update source properties with risectl](/operate/risectl-source-commands) for details.
</Note>
