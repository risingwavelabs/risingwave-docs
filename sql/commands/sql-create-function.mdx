...
Added in v3.1.0-rc.1: `USING LINK` accepts standard URLs: `https://` enables TLS, an omitted port defaults to the scheme (80/443), and a missing scheme defaults to `http://`.
</Note>
