...
You can monitor the progress of background DDL operations using the [SHOW JOBS](/docs/current/sql-show-jobs/) command. The exception is for `sink jobs`. These are immediately marked as completed, since their output will be immediately visible.
