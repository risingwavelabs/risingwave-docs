...
| VARIANT |     | A semi-structured value that preserves leaf types such as integers, decimals, timestamps, binary values, arrays, objects, and nested values when possible. | For syntax, examples, and limitations, see [VARIANT](/sql/data-types/variant). |
