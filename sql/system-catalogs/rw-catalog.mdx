...
| `rw_rate_limit` | Contains information about rate limit configurations for sources in the database, including source names, node names, fragment types, and assigned rate limit values. |
