...
| `rw_features`                         | Contains information about all license-gated features in the system and their availability based on the current license. Includes feature names, descriptions, and whether each feature is currently available.                                                                                                                                                              |
...
| `rw_recovery_info` | Contains database-level recovery information, including the current recovery state, the last processed database and global events, and whether the database is in a global running or recovering mode. |
