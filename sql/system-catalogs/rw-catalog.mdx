...
| `rw_recovery_info` | Contains information about database level recovery, including the recovery state, the last processed database and global events, and whether the database is in global running or recovering mode.  |
