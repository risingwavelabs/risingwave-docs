...
Changed in v2.1.5, v2.2.4, v2.3.0: Creation of embedded Python UDFs is disabled by default. See [UDF configurations](/deploy/node-specific-configurations#udf-configurations) for more information.
