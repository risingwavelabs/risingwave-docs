...
<CardGroup>
  <Card title="Python" icon="python" href="/sql/udfs/use-udfs-in-python" horizontal />
  <Card title="Java" icon="java" href="/sql/udfs/use-udfs-in-java" horizontal />
</CardGroup>
...
<CardGroup>
  <Card title="Python" icon="python" href="/sql/udfs/embedded-python-udfs" horizontal/>
  <Card title="JavaScript" icon="js" href="/sql/udfs/use-udfs-in-javascript" horizontal/>
  <Card title="Rust" icon="rust" href="/sql/udfs/use-udfs-in-rust" horizontal/>
</CardGroup>
...
<CardGroup>
  <Card title="SQL UDFs" icon="database" href="/sql/udfs/sql-udfs" horizontal/>
</CardGroup>
