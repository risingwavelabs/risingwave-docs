...
description: "This article provides a step-by-step guide for defining Rust functions in RisingWave."
sidebarTitle: Rust
---
...
| decimal              | rust\_decimal::Decimal      | rust\_decimal::Decimal                                 |
...
| interval             | arrow\_udf::types::Interval | arrow\_udf::types::Interval                            |
| jsonb                | serde\_json::Value          | serde\_json::Value                                     |
