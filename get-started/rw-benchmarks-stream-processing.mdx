...
For a broader comparison that covers architectural differences, feature sets, and use cases, please see our dedicated articles:

- [**RisingWave vs. Apache Flink: Which one to choose?**](/reference/risingwave-flink-comparison): A high-level overview of the two systems.
- [**RisingWave vs. Flink: Feature-by-feature comparison**](/reference/rw-flink-feature-comparison): A detailed look at SQL capabilities, data types, and more.
...
#### Comparable performance (90 to 110 percent of Flink)
...
- Performance degradation: Reducing Streaming Node memory or introducing irregular access patterns can lead to a high cache miss rate, impacting performance due to increased access to remote storage.
