...
- [**RisingWave vs. Apache Flink: Which one to choose?**](/faq/risingwave-flink-comparison): A high-level overview of the two systems.
- [**RisingWave vs. Flink: Feature-by-feature comparison**](/faq/rw-flink-feature-comparison): A detailed look at SQL capabilities, data types, and more.
