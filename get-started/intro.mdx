...
- **Tool call results**: Fraud scores, anomaly signals, inventory checks, and recommendation outputs pre-computed over live event streams, always current at query time
