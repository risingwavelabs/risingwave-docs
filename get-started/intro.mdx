...
Beyond caching hot data in memory, RisingWave supports [**pluggable disk cache**](/get-started/disk-cache), leveraging local disks or EBS for efficient data caching.
