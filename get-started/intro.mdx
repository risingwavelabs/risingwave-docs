...
description: "RisingWave is real-time event streaming platform. It offers an unified experience for real-time data ingestion, stream processing, data persistence, and low-latency serving."
---
