...
description: "RisingWave is a real-time event streaming platform. It offers an unified experience for real-time data ingestion, stream processing, low-latency serving, and Apache Iceberg™ management."
---
