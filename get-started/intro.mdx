...
### Pluggable Hot Storage  

Beyond caching hot data in memory, RisingWave supports **pluggable hot storage**, leveraging local disks or EBS for efficient data caching.
