...
<Tip>
**Try our SQL generator tool!** We've built an interactive [SQL Assistant](https://sql.risingwave.com/) to help you generate SQL statements for creating sources, tables, sinks, and Iceberg tables. Check it out!
</Tip>

## Step 1: Start RisingWave

RisingWave supports multiple deployment modes. For a comparison of all options, see [Deployment modes overview](/deploy/deployment-modes-overview).
