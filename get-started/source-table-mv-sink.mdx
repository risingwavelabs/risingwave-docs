...
| Connector Type | Directly Query Source? | Directly Create Table? | Primary Key Required? | Can Create MV? | Can Be Sink Input? |
| :--- | :--- | :--- | :--- | :--- | :--- |
| Kafka / Pulsar / Kinesis / NATS / MQTT / PubSub | ✅ | ✅ | ❌ | ✅ | ✅ |
| S3 / GCS / Azure Blob | ✅ | ✅ | ❌ | ✅ | ✅ |
| PostgreSQL CDC | ❌ | ❌ (Must create Source before creating Table) | ✅ | ✅ | ✅ |
| MySQL CDC | ❌ | ❌ (Must create Source before creating Table) | ✅ | ✅ | ✅ |
| SQL Server CDC | ❌ | ❌ (Must create Source before creating Table) | ✅ | ✅ | ✅ |
| MongoDB CDC | ❌ | ❌ (Must create Source before creating Table) | ✅ | ✅ | ✅ |
