...
[**RisingWave Console**](/web-ui/introduction#risingwave-console) is a premium self-hosted operations console for managing RisingWave clusters. It lets you operate multiple clusters from a single UI — running `risectl` commands, automating metadata snapshots, collecting diagnostic data, and running SQL across environments — to accelerate issue detection, streamline troubleshooting, and optimize performance. To request access, contact [sales@risingwave-labs.com](mailto:sales@risingwave-labs.com).
