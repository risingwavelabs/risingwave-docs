...
### Tooling
* On-prem management tool (lightweight version: [Wavekit-lite](https://github.com/risingwavelabs/wavekit-lite))

### Performance and cost
* Disk cache (significantly reduce S3 access cost and improve performance. [Reach out](https://risingwave.com/contact-us/) to learn more)
