...
- [Automatic schema change for PostgreSQL CDC](/ingestion/sources/pg-cdc#automatic-schema-changes)
- [Automatic schema change for MySQL CDC](/integrations/sources/mysql-cdc#automatic-schema-changes)
