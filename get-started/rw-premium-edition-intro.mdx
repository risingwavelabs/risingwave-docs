...
- [Automatic schema changes for PostgreSQL CDC](/ingestion/sources/pg-cdc#automatic-schema-changes)
- [Automatic schema changes for MySQL CDC](/integrations/sources/mysql-cdc#automatic-schema-changes)
