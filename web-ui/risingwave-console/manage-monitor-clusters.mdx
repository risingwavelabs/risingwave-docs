...
After [connecting your RisingWave clusters](/web-ui/risingwave-console/connect-risingwave-clusters) to RisingWave Console, you can use the UI to view their status and access several operational tools provided on the **Cluster Details** page.
