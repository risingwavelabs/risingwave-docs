...
The `v0.6.3-p1` tag is a build-only patch that pins pnpm to version 9 in both Dockerfiles. It does not change Console features. No `v0.6.3` Docker image tag is currently published; use the patched images, whose Docker Hub tags omit the leading `v`:
