...
| **How to get it**     | Included automatically — no extra setup.                                     | **[Premium feature](/get-started/premium-features).** Contact [sales@risingwave-labs.com](mailto:sales@risingwave-labs.com) to obtain the image or binary. |
...
RisingWave Console is a [**premium feature**](/get-started/premium-features) and is not included with RisingWave. To obtain the image or binary and discuss version compatibility, contact RisingWave Labs at [sales@risingwave-labs.com](mailto:sales@risingwave-labs.com).
