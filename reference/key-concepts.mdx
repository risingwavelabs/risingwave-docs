...
* **Acts as the SQL gateway:** It handles user requests and is compatible with the PostgreSQL wire protocol, allowing tools like `psql` to connect seamlessly.
