---
title: "SHOW CLUSTER"
description: "Use the `SHOW CLUSTER` command to display various details of your cluster, such as the cluster's address, type, state, and starting time."
---

It will also indicate the number of parallel units the cluster is utilizing and whether it is currently streaming data, serving data, or unschedulable.
