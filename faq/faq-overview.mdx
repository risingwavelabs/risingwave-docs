...
If you can't find an answer here, please see our **[Support and Escalation](/support)** guide to find the right channel for your question. You can also ask in the [#ask-ai channel](https://risingwave-community.slack.com/archives/C06R8DA3DGT) of our [Community Slack](https://www.risingwave.com/slack). Our AI assistant there provides answers based on RisingWave's documentation, codebase, and community discussions.
