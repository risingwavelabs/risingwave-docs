...
<Frame>
  <img src="/images/wal-level-fd178cfc3ce9feab96325eeb712107d1.png"/>
</Frame>

2. Go to the **Databases** page and modify your instance to use the **pg-cdc** parameter group.

<Frame>
  <img src="/images/modify-instances-01e38566fba1124b8c714046e46a30b3.png"/>
</Frame>
...
| publication.name          | Optional. Name of the publication. By default, the value is rw\_publication. For more information, see [Multiple CDC source tables](#multiple-cdc-source-tables).                                                                                                                                                                                                                                           |
