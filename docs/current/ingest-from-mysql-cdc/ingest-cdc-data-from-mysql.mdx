...
1. Turn on binary logging and choose a non-zero value for the **Retention period**.![Set retention period to a nonzero value](/images/ret-period-c344fa251f29cf9c69cfc03d5d6cbe3e.png)
2. Create a parameter group for MySQL instances. We created a parameter group named MySQL-CDC for the instance that runs MySQL 5.7.x.![Create a parameter group](/images/parameter-group-8a31e13e8ee44c884bdfffeb9e6c05d3.png)
3. Click the MySQL-CDC parameter group to edit the values of **binlog\_format** to **ROW** and **binlog\_row\_image** to **full**.![Set binlog_format to row](/images/binlog-format-457555599253ef2fc6a65787b3f92e63.png) ![Set binlog_row_image to full](/images/binlog-row-f236a1b097e0668a126ee7f4c9f7ead0.png)
4. Modify your RDS instance and apply the modified parameter group to your database.![Select modify](/images/modify-RDS-64d17849d070ee28477c61345b8a9ad1.png) ![Apply changes to database](/images/apply-to-database-7d10bd53c6e0dab7b40135150d0c8e69.png)
5. Click **Continue** and choose **Apply immediately**. Finally, click **Modify DB instance** to save the changes. Remember to reboot your MySQL instance.![Save changes made to MySQL RDS instance](/images/save-changes-01e38566fba1124b8c714046e46a30b3.png)
