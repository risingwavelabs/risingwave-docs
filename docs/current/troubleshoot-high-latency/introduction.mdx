---
title: "High latency"
description: "High latency is a prevalent performance problem in streaming systems, and it can have multiple underlying causes. Excessive latency not only affects the freshness of data but also poses a risk to the overall stability of the system, potentially leading to out-of-memory (OOM) errors."
---
...
<Frame>
  <img src="/images/example_bad_barrier_latency-5690598f1e80263bf6f645b8c438937d.png"/>
</Frame>
...
The term "Cardinality" describes how many distinct values exist in a column. For example, "nation" often has a lower cardinality, while "user\_id" often has a higher cardinality.
...
<Frame>
  <img src="/images/example_high_join_matched_rows-e4c6ee36b63a15c454c4b218ab8a01ce.png"/>
</Frame>
