...
| match\_pattern       | Conditional. This field is used to find object keys in gcs.bucket\_name that match the given pattern. Standard Unix-style [glob](https://en.wikipedia.org/wiki/Glob%5F%28programming%29) syntax is supported.                                                                                                                                                                                                                           |                                                                                                                                                        |
