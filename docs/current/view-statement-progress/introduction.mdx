...
<CardGroup cols={2}>
 <Card title="SHOW JOBS" icon="arrow-right" href="/docs/current/sql-show-jobs/" horizontal/>
  <Card title="CANCEL JOBS" icon="arrow-right" href="/docs/current/sql-cancel-jobs/" horizontal/>
</CardGroup>
