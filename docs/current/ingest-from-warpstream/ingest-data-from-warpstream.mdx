...
sidebarTitle: WarpStream
description: "You can ingest data from [WarpStream](https://www.warpstream.com/), an Apache Kafka-compatible data streaming platform built directly on top of object storage, into RisingWave."
---
...
In RisingWave, create a source named "website\_visits" to connect RisingWave to the WarpStream topic:
