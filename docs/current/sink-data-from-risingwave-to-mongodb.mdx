...
| mongodb.bulk\_write.max\_entries | Optional. The maximum entries that will accumulate before performing the bulk write. Defaults to 1024\. Default value is 1024.                                                                                                                                                                                    |
