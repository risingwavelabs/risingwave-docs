...
description: "Use the `ORDER BY` clause to sort the result set of a query based on one or more columns in ascending or descending order. It is commonly used to organize data in a specific sequence for better analysis and presentation."
---
...
Let's assume we have a table named "employees" with columns "employee\_id", "employee\_name", and "salary".
