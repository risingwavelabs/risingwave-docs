...
description: "RisingWave is a Postgres-compatible SQL database engineered to offer the _**simplest**_ and _**most cost-effective**_ approach for **processing**, **analyzing**, and **managing** real-time event streaming data."
---
...
<Frame>
  <img src="/images/current/intro/stream_processing_with_and_without_rw-66b23a167f1bd2f3a8a14d56336e17b2.jpeg"/>
</Frame>
<br/>
<CardGroup>
  <Card title="See the architecture" icon="sitemap" iconType= "solid" href="/docs/current/architecture/" horizontal/>
