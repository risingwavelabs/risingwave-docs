...
<Frame>
  <img src="/images/search-rds-2684527d0b05116630757ec49b733512.png"/>
</Frame>

1. Create a database with **MySQL** as the **Engine type**. We recommend setting up a username and password or using other security options.

<Frame>
  <img src="/images/mysql-config-f6c9f8b4f3722306c923dbd13057edbf.png"/>
</Frame>
1. When the new instance becomes available, click on its panel.

<Frame>
  <img src="/images/new-panel-c6c75b2d23ce62cc45819271359bf578.png"/>
</Frame>

1. From the **Connectivity** panel, we can find the endpoint and connection port information.

<Frame>
  <img src="/images/connectivity-23952577fbb90eab5294dd9342b8969d.png"/>
</Frame>
