...
slug: /ql-udfs
title: SQL UDFs
description: Define SQL UDFs.
---
<head>
  <link rel="canonical" href="https://docs.risingwave.com/docs/current/sql-udfs/" />
</head>

You can define SQL UDFs in RisingWave by using the [`CREATE FUNCTION`](/sql/commands/sql-create-function.md) command.
