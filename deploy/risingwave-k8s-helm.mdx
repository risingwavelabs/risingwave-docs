...
<Note>
Review these prerequisites before starting the deployment. You will need a working Kubernetes cluster, Helm installed locally, and enough cluster resources for the selected RisingWave configuration.
</Note>
