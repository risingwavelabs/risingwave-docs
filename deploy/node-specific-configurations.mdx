...
|------------------------------------------|-----------------------------------------|
| `default_enable_mem_preload_state_table` | Whether to enable preloading all rows in memory for state tables by default. If `true`, all capable state tables preload their state into memory. |
