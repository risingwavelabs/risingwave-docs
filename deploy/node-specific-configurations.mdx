...
| `join_hash_map_evict_interval_rows`      | `16`    | Number of rows processed between periodic evictions of the join hash map cache, for hash join and as-of join executors. Set to `0` to disable periodic eviction. |
