...
<Note>
Before upgrading, review the [version upgrade best practices](/operate/upgrade-best-practices) guide for pre-upgrade preparation, compatibility constraints, rollback procedures, and post-upgrade validation checklists.
</Note>
